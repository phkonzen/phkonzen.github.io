...
def deploy(odir):
  ...
  body += '<p class="d-flex justify-content-center"><a class="btn btn-primary mybtn" href="./notas/index.html" role="button"><i class="fa-solid fa-file-lines"></i> &nbsp Site Oficial</a></p>'
