...
body += '<a href="https://www.notaspedrok.com.br/notas"><img src="./pics/logoRabbit.jpg" class="rounded-circle mx-auto d-block" alt="Notas de Aula" style="width: 15rem; height: auto;"></a>'
body += '</div>'
